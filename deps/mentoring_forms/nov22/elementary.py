...
__table_name__ = 'LM_NOV22_CORE2'
__col_name__ = 'daily_report_pdf_status'
__DOC_GEN_CONFIG_ID__ = 1
__DOC_GEN_TEMPLATE_ID__ = 67

__LM_TLMTYPE1_PHY__ = 'LM_NOV22_CLAS1DTLSCLAS1CLASBSRVPHY_TLMTYPE1_PHY'
__LM_TLMTYPE2_PHY__ = 'LM_NOV22_CLAS2DTLSCLAS2CLASBSRVPHY_TLMTYPE2_PHY'
__LM_TLMTYPE3_PHY__ = 'LM_NOV22_CLAS3DTLSCLAS3CLASBSRVPHY_TLMTYPE3_PHY'

__LM_STU_AWARENESS_1__ = 'LM_NOV22_CLAS1DTLSCLAS1STUDENTWRNES_STU_AWARENESS_1'
__LM_STU_AWARENESS_2__ = 'LM_NOV22_CLAS2DTLSCLAS2STUDENTWRNES_STU_AWARENESS_2'
__LM_STU_AWARENESS_3__ = 'LM_NOV22_CLAS3DTLSCLAS3STUDENTWRNES_STU_AWARENESS_3'

__LM_TEACHER_AWARENESS__ = 'LM_NOV22_PHYSCLDTLSSTTEDGTLLRNNGPHY_TEACHER_AWARENESS'
__LM_AWARENESS_UDAAN1__ = 'LM_NOV22_PHYSCLDTAILS_STATE_DN_PHY_AWARENESS_UDAAN1'
__LM_REMEDIAL_PERIOD__ = 'LM_NOV22_PHYSCLDTAILS_STATE_DN_PHY_REMEDIAL_PERIOD'
__LM_SCHOOLSUPP_AREAS_PHY__ = 'LM_NOV22_VST_RPRTNG_SCHL_FDBCK_PHY_SCHOOLSUPP_AREAS_PHY'
...
def create_pdf_request(**context):
    ...
    for mentor in mentors:
        pdf_data = {
            ...
            '39': check_for_student_assessment(mentor['CLASS1_DETAILS_SUBJECT1_PHY'], mentor['CLASS1_DETAILS_CLASS1_STUDENT_SST_QUES1_CLASS1_FLN']),
            '40': check_for_student_assessment(mentor['CLASS2_DETAILS_SUBJECT2_PHY'], mentor['CLASS2_DETAILS_CLASS2_STUDENT_SST_QUES1_CLASS2_FLN']),
            '41': check_for_student_assessment(mentor['CLASS3_DETAILS_SUBJECT3_PHY'], mentor['CLASS3_DETAILS_CLASS3_STUDENT_SST_QUES1_CLASS3_FLN']),
            '42': check_for_student_assessment(mentor['CLASS1_DETAILS_SUBJECT1_PHY'], mentor['CLASS1_DETAILS_CLASS1_STUDENT_SST_QUES2_CLASS1_FLN']),
            '43': check_for_student_assessment(mentor['CLASS2_DETAILS_SUBJECT2_PHY'], mentor['CLASS2_DETAILS_CLASS2_STUDENT_SST_QUES2_CLASS2_FLN']),
            '44': check_for_student_assessment(mentor['CLASS3_DETAILS_SUBJECT3_PHY'], mentor['CLASS3_DETAILS_CLASS3_STUDENT_SST_QUES2_CLASS3_FLN']),
            '45': check_for_student_assessment(mentor['CLASS1_DETAILS_SUBJECT1_PHY'], mentor['CLASS1_DETAILS_CLASS1_STUDENT_SST_QUES1_CLASS1_PHY']),
            '46': check_for_student_assessment(mentor['CLASS2_DETAILS_SUBJECT2_PHY'], mentor['CLASS2_DETAILS_CLASS2_STUDENT_SST_QUES1_CLASS2_PHY']),
            '47': check_for_student_assessment(mentor['CLASS3_DETAILS_SUBJECT3_PHY'], mentor['CLASS3_DETAILS_CLASS3_STUDENT_SST_QUES1_CLASS3_PHY']),
            '48': check_for_student_assessment(mentor['CLASS1_DETAILS_SUBJECT1_PHY'], mentor['CLASS1_DETAILS_CLASS1_STUDENT_SST_QUES2_CLASS1_PHY']),
            '49': check_for_student_assessment(mentor['CLASS2_DETAILS_SUBJECT2_PHY'], mentor['CLASS2_DETAILS_CLASS2_STUDENT_SST_QUES2_CLASS2_PHY']),
            '50': check_for_student_assessment(mentor['CLASS3_DETAILS_SUBJECT3_PHY'], mentor['CLASS3_DETAILS_CLASS3_STUDENT_SST_QUES2_CLASS3_PHY']),
            '51': get_multi_student_awareness(cur, mentor['_URI'], __LM_STU_AWARENESS_1__),
            '52': get_multi_student_awareness(cur, mentor['_URI'], __LM_STU_AWARENESS_2__),
            '53': get_multi_student_awareness(cur, mentor['_URI'], __LM_STU_AWARENESS_3__),
            '54': get_from_student_homework_map(mentor['CLASS1_DETAILS_CLASS1_STUDENTAWARENESS_STU_HOMEWORK_1']),
            '55': get_from_student_homework_map(mentor['CLASS2_DETAILS_CLASS2_STUDENTAWARENESS_STU_HOMEWORK_2']),
            '56': get_from_student_homework_map(mentor['CLASS3_DETAILS_CLASS3_STUDENTAWARENESS_STU_HOMEWORK_3']),
            '57': get_from_frequency_map(mentor['CLASS1_DETAILS_CLASS1_STUDENTAWARENESS_TEACHER_HOMEWORK_1']),
            '58': get_from_frequency_map(mentor['CLASS2_DETAILS_CLASS2_STUDENTAWARENESS_TEACHER_HOMEWORK_2']),
            '59': get_from_frequency_map(mentor['CLASS3_DETAILS_CLASS3_STUDENTAWARENESS_TEACHER_HOMEWORK_3']),
            '60': parse_bool_or_other(mentor['CLASS1_DETAILS_CLASS1_TEACHER_FEED_PHY_TEACHERFEEDBACK1_PHY']),
            '61': parse_bool_or_other(mentor['CLASS2_DETAILS_CLASS2_TEACHER_FEED_PHY_TEACHERFEEDBACK2_PHY']),
            '62': parse_bool_or_other(mentor['CLASS3_DETAILS_CLASS3_TEACHER_FEED_PHY_TEACHERFEEDBACK3_PHY']),
            '63': validate_data(mentor['CLASS1_DETAILS_CLASS1_TEACHER_FEED_PHY_FEEDBACKDETAILS11_PHY']),
            '64': validate_data(mentor['CLASS2_DETAILS_CLASS2_TEACHER_FEED_PHY_FEEDBACKDETAILS21_PHY']),
            '65': validate_data(mentor['CLASS3_DETAILS_CLASS3_TEACHER_FEED_PHY_FEEDBACKDETAILS31_PHY']),
            '66': parse_bool_or_other(mentor['VISIT_REPORTING_SCHOOL_FEEDBACK_PHY_SCHOOLHEAD_PHY']),
            '67': validate_data(mentor['VISIT_REPORTING_SCHOOL_FEEDBACK_PHY_SCHOOLHEAD_NAME']),
            '68': get_multi_schoolsupp_areas(cur, mentor['_URI'], __LM_SCHOOLSUPP_AREAS_PHY__),
            '69': validate_data(mentor['VISIT_REPORTING_SCHOOL_FEEDBACK_PHY_ADD_SCHOOL_PHY']),
            '70': validate_data(mentor['VISIT_REPORTING_SCHOOL_FEEDBACK_PHY_IMPROVEDIF_COMMENTS1']),
            '71': validate_data(mentor['VISIT_REPORTING_SCHOOL_FEEDBACK_PHY_DEGRADEDIF_COMMENT2']),
            '72': get_multi_teacher_awareness(cur, mentor['_URI'], __LM_TEACHER_AWARENESS__),
            '73': get_from_frequency_map(mentor['PHYSCLDETAILS_STATE_DIGITAL_LERNNG_PHY_DIKSHA_FREQUENCY']),
            '74': validate_data(mentor['PHYSCLDETAILS_STATE_DIGITAL_LERNNG_PHY_DIGITALTOOLS_CHALLENGES']),
            '75': validate_data(mentor['PHYSCLDETAILS_STATE_DIGITAL_LERNNG_PHY_DIGITALTOOLS_BEST']),
            '76': parse_bool_or_other(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_AWARENESS_UDAAN']),
            '77': get_multi_awareness_udaan1(cur, mentor['_URI'], __LM_AWARENESS_UDAAN1__),
            '78': get_multi_remedial_period(cur, mentor['_URI'], __LM_REMEDIAL_PERIOD__),
            '79': parse_bool_or_other(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_REMEDIAL_VISIT']),
            '80': get_from_remedial_timing_map(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_REMEDIAL_TIME']),
            '81': get_from_remedial_day_map(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_REMEDIAL_DAY']),
            '82': get_from_frequency_map(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_DIGITAL_UDAAN']),
            '83': validate_data(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_UDAAN_CHALLENGES']),
            '84': validate_data(mentor['PHYSICALDETAILS_STATE_UDAAN_PHY_UDAAN_BEST']),
        }
